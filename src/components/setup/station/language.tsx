...
export const LanguageCard = (props: any) => {
    ...
    return (
        <>
            <Card style={{ padding: "4.9% 14.1% 7.01% 8.2%", border: "1px solid #DDDDDD", borderRadius: "10px" }}>
                <Typography className="t1">
                    Language
                </Typography>
                <Grid className="languagecheckBoxStyle" style={{ display: "flex", flexDirection: "column", paddingLeft: "10%" }}>
                    <FormControlLabel onClick={handleChange}
                        control={
                            <Checkbox checked={enableEnglish} className="intigratinCheckbox" size="small" name="language1" value="English" />
                        }
                        label={<span className="intigratinCheckboxlabel">English</span>}
                    />
                    <FormControlLabel onClick={handleChange}
                        control={
                            <Checkbox checked={enableHindi} className="intigratinCheckbox" size="small" name="language2" value="Hindi" />
                        }
                    ...
                    <Grid container>
                        <Grid item xs={6} style={{ paddingRight: "34%" }}>
                            <FormControlLabel onChange={handleChange}
                                control={
                                    <Checkbox checked={regionalLang} className="intigratinCheckbox" size="small" name="regionalLang" value={regionalLang} />
                                }
