...
useEffect(() => {
    ...
    return (
        <>
            <Grid item xs={12}>
                <Card style={{padding: "1.55% 4.4% 1.5% 5.4%", border: "1px solid #DDDDDD", borderRadius: "10px" }}>
                    <Typography className="t1">
                        Auto Train Load/Delete
                    </Typography>
                    <Grid container>
                        <Grid container xs={12} style={{ paddingTop: "1.9%"}}>
                            <Grid xs={5} style={{ display: "flex", alignItems: "center", justifyContent: "left" }}>
                                <Typography className="intigratintext3">
                                    Available Platforms
                                </Typography>
                            </Grid>
                            <Grid xs={3} style={{display:'flex',justifyContent:'center'}}>
                                <TextField className="SelectAvailPlatform" name="availablePlatforms" required={true} variant="outlined" onChange={handleChange} value={stationDetails?.availablePlatforms} />
                            </Grid>
                            <Grid xs={4} style={{ display: "flex", alignItems: "center", justifyContent: "flex-start" }}>
                                                ...
                                                platformNo?.map((el: any, i: any) => {
                                                    return (
                                                        <Grid container style={{ paddingBottom: "3%" }}>
                                                            <Grid item xs={4} className="platfomNO">
                                                                Platform Number {i+1}
                                                            </Grid>
                                                            <Grid item xs={6}>
                                                                <TextField
                        ...
                        <Grid container xs={12} style={{ paddingTop: "1.99%" }}>
                            <Grid container xs={12}>
                                ...
                                <Grid container xs={3} style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                                    ...
                                    <TextField className="autoLoadText" size="small" variant="outlined" name="autoLoadTrainEveryMin" required={true} onChange={handleChange} value={stationDetails?.autoLoadTrainEveryMin} /> : 
                                    <TextField disabled className="autoLoadText" size="small" variant="outlined" name="autoLoadTrainEveryMin" value={stationDetails?.autoLoadTrainEveryMin} />
                                    }
                                </Grid>
                        ...
                        <Grid container xs={12} style={{ paddingTop: "1.99%" }}>
                            <Grid container xs={12} >
                                ...
                                {stationDetails?.autoDelete ?
                                    <TextField className="autoLoadText" size="small" variant="outlined" name="autoDeleteTrainEveryMin" required={true} onChange={handleChange} value={stationDetails?.autoDeleteTrainEveryMin} />:<TextField className="autoLoadText" size="small" variant="outlined" name="autoDeleteTrainEveryMin" disabled value={stationDetails?.autoDeleteTrainEveryMin} />}
                                </Grid>
                                <Grid xs={3} style={{ display: "flex", alignItems: "center", justifyContent: "flex-start" }}>
                                    <Typography className="intigratintext3">
                                        Minutes
                        ...
                        <Grid container xs={12} style={{ paddingTop: "1%" }}>
                            <Grid container xs={12}>
                                ...
                                <Grid container xs={3} style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                                    ...
                                    <TextField className="autoLoadText" size="small" variant="outlined" name="autoSendDataTimeInterval" required={true} onChange={handleChange} value={stationDetails?.autoSendDataTimeInterval} />:<TextField className="autoLoadText" size="small" variant="outlined" name="autoSendDataTimeInterval"disabled value={stationDetails?.autoSendDataTimeInterval} />
                                    }
                                </Grid>
                                <Grid xs={3} style={{ display: "flex", alignItems: "center", justifyContent: "flex-start" }}>
                                    <Typography className="intigratintext3">
