...
export const AnnouncementPrefer = (props: any) => {
    ...
    return (
        <>
            <Card style={{ padding: "4.9% 14.1% 10.01% 8.2%", border: "1px solid #DDDDDD", borderRadius: "10px",height: "125px"}}>
                <Typography className="t1">
                    Announcement Preferences
                </Typography>
                <Grid >
                    <Grid container style={{ paddingTop: "10px" }}>
                        <Grid item xs={8} style={{ textAlign: "start", paddingLeft: "20px" }}>
                            <FormControlLabel onChange={handleChange}
                                control={
                                    <Checkbox checked={announcementPrefer1} className="intigratinCheckbox" size="small" name="announcementPrefer01" />
                                }
                    ...
                    <Grid container style={{ paddingTop: "10px" }}>
                        <Grid item xs={8} style={{ textAlign: "start", paddingLeft: "20px" }}>
                            <FormControlLabel onChange={handleChange}
                                control={
                                    <Checkbox checked={announcementPrefLang2} className="intigratinCheckbox" size="small" name="announcementPrefLang2" />
                                }
                                label={<span className="intigratinCheckboxlabel">Second Language</span>}
                            />
                        </Grid>
                        <Grid item xs={4}>
                    ...
                    <Grid container style={{ paddingTop: "10px" }}>
                        <Grid item xs={8} style={{ textAlign: "start", paddingLeft: "20px" }}>
                            <FormControlLabel onChange={handleChange}
                                control={
                                    <Checkbox checked={announcementPrefLang3} className="intigratinCheckbox" size="small" name="announcementPrefLang3" />
                                }
