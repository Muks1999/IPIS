...
export const EnableDisable = (props:any) => {
  ...
  return (
    <>
      <Grid style={{paddingTop:"8%",paddingBottom:"9%",paddingRight:"18.35%",paddingLeft:"18.35%"}}className="enableDisableGridStyle">
        <Card  className={appUser.userRole == "ROLE_STATION MASTER" ? "overlapBackground  enableDisableCardStyle":" enableDisableCardStyle"}>
        {   appUser.userRole == "ROLE_STATION MASTER" ? <Grid className="stationForm formFields">

        </Grid>: <></>
        }
          <Typography className="txt">
            <b>Enable/ Disable Display Boards</b>
          </Typography>
          <Grid container>
            <Grid item xs={6} className="EDtext">
  ...
  <Grid></Grid>:
          <Grid
            container
            style={{ justifyContent: "center", paddingTop: "20px",marginLeft: "10%"}}
          >
          
                 <div className="EdSaCanc">
                   <Button
