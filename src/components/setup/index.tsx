...
export const Setup = (props:any) => {
  ...
  return (
    <>
      ...
      !stationData ? (<div style={{ display: 'flex', justifyContent: "center", alignItems: "center", height: '50vh' }}><Grid style={{ textAlign: "center" }}>Redirecting...<CircularProgress /></Grid></div>) :
