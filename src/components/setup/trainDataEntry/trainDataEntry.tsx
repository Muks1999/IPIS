      ...
      <Grid container>
        <Grid item xs={12} className="trainDataMainCard">
          ...
          <Card className="secondCard">
            <Grid container>
              <Grid container style={{ padding: "10px 9px 9px 7px", display: "flex", justifyContent: "space-between" }}>
                <Grid item>
                  <Typography className="northend">
                    <img style={{ paddingRight: "9px" }} src={ArrowUp} />
                    <TextField disabled size="small" name="frontSideEnd" placeholder="Front Side End" onChange={handleChange} value={input.frontSideEnd} className="frontBackEnd" variant="outlined" />
                  </Typography>
                </Grid>
                <Grid item>
                  <Typography className="northend">
                    <TextField disabled size="small" name="backSideEnd" placeholder="Back Side End" onChange={handleChange} value={input.backSideEnd} className="frontBackEnd" variant="outlined" />
              ...
              <Grid item xs={12}>
                <div className="daysNameItem">
                  {input.maximumCoach === 0 ? <div style={{ padding: "10px 20px" }}>Please select maximum Coach Number</div> : coacheView()}
