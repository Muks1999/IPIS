...
useEffect(()=>{
    ...
    return (
        <>
            <Grid>
                <Card style={{ padding: "2.21% 4.11% 2.59% 4.11%" }}>
                    <Grid>
                        {appUser?.userRole == "ROLE_STATION MASTER" ? <></> :
                        ...
                        <Card style={{ padding: "10px", border: "1px solid #DDDDDD", marginTop: "1.75%" }}>
                            <Typography className="exisitingData" >
                               <b> Exisitng Station Data</b>
                            </Typography>
                                <TableContainer style={{ maxHeight: "26vh" }}>
