...
export const OnlineTrainDataEntry = (props: any) => {
  ...
  const rundays = () => {
    return days.map((el: any, i: any) => {
      return (
        <div className="daysName onlineTrainDataDetails">
          <FormControlLabel
            ...
            <Grid container>
              <Grid item xs={7} className="padStyle trainDataItem">
                <Grid container>
                  ...
                  <Grid item xs={8} className="onlineTrainDataDetails">
                    <TextField
                      disabled
                      size="small"
                  ...
                  <Grid item xs={8} className="onlineTrainDataDetails">
                    ...
                    />
                    {/* <KeyboardOutlinedIcon className="keyBoard" /> */}
                  </Grid>
                  <Grid item xs={4} className="trainDataItem">
                    <Typography className="trainDataItemName">
                      Source Station
                    ...
                    <Grid container>
                      <Grid item xs={3}>
                        <select
                          disabled
                          name="sourceStation"
                          className="trainDataDropDwn onlineTrainDataDetails"
                          required={true}
                          onChange={handleChange}
                      ...
                      <Grid item xs={7} className="trainDataItem">
                        ...
                        <select
                          ...
                          className="trainDataDropDwnRight onlineTrainDataDetails"
                          required={true}
                          onChange={handleChange}
                ...
                <Grid container>
                  ...
                  <Grid item xs={4}>
                    <select
                      disabled
                      name="platformNo"
                      className="trainDataDropDwnSubRight onlineTrainDataDetails"
                      required={true}
                      onChange={handleChange}
                  ...
                  <Grid item xs={3}>
                   ...
                   {/* /   <MuiPickersUtilsProvider utils={DateFnsUtils}> */}
                        ...
                        <TextField
                        disabled
                        className="onlineTrainDataDetails txtBox"
                          variant="outlined"
                          name="scheduleArrivalTime"
                          value={input.scheduleArrivalTime}
                          onChange={handleChange}
                    ...
                    {/* <select disabled name="scheduleArrivalTime" className="trainDataDropDwnSubRight" required={true} onChange={handleChange} value={input.scheduleArrivalTime}>
                                            <option value="0" selected>
                                                Select
                                            </option>
                  ...
                  <Grid item xs={3}>
                    ...
                    {/* <select disabled name="scheduleDepartureTime" className="trainDataDropDwnSubRight" required={true} onChange={handleChange} value={input.scheduleDepartureTime}>
                                            <option value="0" selected>
                                                Select
                                            </option>
                                            <option value="00:00">00:00</option>
                  ...
                  <Grid item xs={7}>
                    <select
                      disabled
                      name="trainType"
                      className="trainTypeDropDwnSubRight onlineTrainDataDetails"
                      required={true}
                      onChange={handleChange}
                  ...
                  <Grid item xs={7}>
                    <div className="intrStation">
                      {/* <select name="viaStation1" className="intrStationDropDwnSubRight mr-79" required={true} onChange={handleChange}>
                                                <option value="0" selected>
                                                    Select
                                                </option>
                      ...
                      <FormControl>
                        <Select
                          disabled
                          className="intrStationDropDwnSubRight onlineTrainDataDetails"
                          multiple
              ...
              <Grid item xs={12}>
                <Grid container>
                  <Grid item xs={1}></Grid>
                  <Grid item xs={10} className="daysNameItem">
                    <div className="daysNameHed">Running Days</div>
                    {rundays()}
                  </Grid>
                </Grid>
              </Grid>
                ...
                <Grid item>
                  <Typography className="northend">
                    ...
                    <TextField
                      ...
                      className="frontBackEnd onlineTrainDataDetails"
                      variant="outlined"
                    />
                  </Typography>
                </Grid>
