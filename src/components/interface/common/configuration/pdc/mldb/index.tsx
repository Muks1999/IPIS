      ...
      <Grid item xs={12}>
        <Card className="mldbCardPdc">
          ...
          <Grid container className={appUser.userRole == "ROLE_STATION MASTER" ? "overlapBackground" : ""}>
            ...
            <Grid item xs={7}>
              <Grid className="mldbGridPdc">
                <TextField disabled className="mldbBoxStyle mr-10" variant="outlined" type="text" name="ipAddress1" required={true} value={interfaceInput.ipAddress1} onChange={handleChange} />
                <TextField disabled className="mldbBoxStyle mr-10" variant="outlined" type="text" name="ipAddress2" required={true} value={interfaceInput.ipAddress2} onChange={handleChange} />
                <TextField disabled className="mldbBoxStyle mr-10" variant="outlined" type="text" name="ipAddress3" required={true} value={interfaceInput.ipAddress3} onChange={handleChange} />
