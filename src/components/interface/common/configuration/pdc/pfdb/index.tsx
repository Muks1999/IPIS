...
useEffect(() => {
  if(deleteState.isSuccess == true && deleted == true){
    ...
    return (
        <>
            <Grid item xs={12}>
                <Card  style={{ paddingBottom: "8px" }} className={appUser.userRole == "ROLE_STATION MASTER" ? "overlapBackground pdbCard":"pdbCard"}>
                {  
            appUser.userRole == "ROLE_STATION MASTER" ? <Grid className="stationForm formFields">
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={7}>
                            <Grid className="pdbIpGrid">
                                <TextField disabled className="ipboxstyle mr-10" variant="outlined" name="ipAddress1" required={true} value={interfaceInput.ipAddress1} onChange={handleChange} />
                                <TextField disabled className="ipboxstyle mr-10" variant="outlined" name="ipAddress2" required={true} value={interfaceInput.ipAddress2} onChange={handleChange} />
                                <TextField  disabled aria-disabled className="ipboxstyle mr-10" variant="outlined" name="ipAddress3" required={true} value={interfaceInput.ipAddress3} onChange={handleChange} />
                        ...
                        <Grid item xs={7}>
                            ...
                            <select className="selectfieldPlt ml-18" name="platformNo2" required={true} value={interfaceInput.platformNo2} onChange={handleChange}>
                                <option value="0">Select</option>
                                {platformNumbers?.map((platformNo: any, i: any) => {
                                    return (
                    ...
                    {appUser.userRole == "ROLE_STATION MASTER" ? <></> :
                        <div style={{ paddingTop: "1.59%", display: "flex", justifyContent: "center", alignItems: "center" }}>
