...
useEffect(()=>{
    ...
    const deviceIdView = () => {
        return (
            <select disabled={!message?.platformNo} name="deviceId" className="messageControlBox" value={message?.deviceId} onChange={handleChange}>
    ...
    const platformNoView = () => {
        return (
            <select disabled={disabled} name="platformNo" className="messageControlBox" value={message?.platformNo} onChange={handleChange}>
    ...
    return (
        <>
            <Grid>
                <Card className="sideMainCardCss">
                    <Grid container>
                        <Grid item xs={3}>
                            <Grid>
                                <Card className="sidechildCardCss">
                                    <Grid>
                                        <Typography>Message Controls</Typography>
                                        <Typography className="msgControlTxt">Control the setting for displaying message</Typography>
                                        <Grid container>
                                            <Grid item xs={4} className="displayBoardTxt">
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid item xs={8}>
                                                <select
                                                    name="speed"
                                                    className="messageControlBox" onChange={handleChange}
                                                    value={message?.speed}>
                                                    <option value="" >
                                                        Select
                                                    </option>
                            ...
                            <Grid>
                                <Card className="addMessage">
                                    <Grid>
                                        ...
                                        <Typography className="addMessageContent">
                                            Add message to displayed on Display Board. Seprate AGDB and MLDB lines by #
                                        </Typography>
                                        <Grid container>
                                            <Grid item xs={12} className="paddingLeftCss">
                                                <Grid item xs={12} >
                                                    <Grid container className="marginTop3Css">
                                                        <Grid item xs={2} className="messageTxt">
                                                ...
                                                <Grid item xs={12}>
                                                    <Grid container className="marginTop2Css">
                                                        <Grid item xs={2} className="messageTxt">
                                                            Message (Hindi)
                                                        </Grid>
                                                        <Grid item xs={6}>
                                        ...
                                        <Grid  container className="cancelSubmitCss">
                                            <Button
                                                type="reset"
                                                value="Reset"
                                                variant="outlined"
                                            ...
                                            >
                                                <span className="i">{message.id == 0 ? buttonText : updateText}</span>
                                            </Button>

                                        </Grid>
                                        <span> {msgError != "" ? <div style={{ color: "red", textAlign: "center" , position: "relative", right :"20%"}}> {msgError}</div> : <></>}
                                        </span>
                                        
                                    </Grid>
                                </Card>
                                <Card className="marginTop10">
                                    <Grid>
                                        <Typography className="savedMessage" >
                                            Saved Messages
                                        </Typography>
                                            <TableContainer className="messageTable" style={{maxHeight:"45vh"}}>
                                        ...
                                        <Grid container className="cancelDisplayButtonCss">
                                            ...
                                            >
                                                <span className="i">Display Selected Media</span>
                                            </Button>
                                        </Grid>
                                    </Grid>
                                </Card>
